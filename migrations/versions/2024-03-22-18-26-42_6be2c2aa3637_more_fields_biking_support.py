...
old_parking_site_types: list[str] = ['ON_STREET', 'OFF_STREET_PARKING_GROUND', 'UNDERGROUND', 'CAR_PARK', 'OTHER']
...
def upgrade():
    ...
    if engine_name == 'postgresql':
        ...
        sa.Enum(*new_parking_site_types, name='parkingsitetype').create(op.get_bind())
