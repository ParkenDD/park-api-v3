...
Revision ID: e4d1d4ee8646
Revises: 
Create Date: 2023-10-10 17:35:22.831140
...
def upgrade():
    ...
    op.create_table('source',
        ...
        sa.Column('last_import', sqlalchemy_utc.sqltypes.UtcDateTime(timezone=True), nullable=True),
    ...
    op.create_table('parking_site',
        ...
        sa.Column('park_and_ride_type', sa.String(256), nullable=True),
        sa.Column('is_supervised', sa.Boolean(), nullable=True),
        sa.Column('has_realtime_data', sa.Boolean(), nullable=False),
        sa.Column('static_data_updated_at', sa.DateTime(), nullable=True),
        sa.Column('realtime_data_updated_at', sa.DateTime(), nullable=True),
