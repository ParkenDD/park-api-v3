...
class LogMessageType(Enum):
    ...
    REALTIME_PARKING_SITE_HANDLING = 'realtime-parking-site-handling'
    STATIC_PARKING_SPOT_HANDLING = 'static-parking-spot-handling'
    REALTIME_PARKING_SPOT_HANDLING = 'realtime-parking-spot-handling'
